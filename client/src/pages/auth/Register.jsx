...
const Register = () => {
  ...
  const onSubmit = async (data) => {
    try {
      setIsLoading(true);
      const response = await registerUser({ name: data.name, email: data.email, password: data.password, role: selectedRole });
      if (response.success) {
      ...
      <div className="w-full max-w-md">
        ...
        <Card>
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-center">Join thousands of learners and instructors today</CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-5">
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                { value: 'student', label: 'I want to Learn', sublabel: 'Access courses', icon: BookOpen },
                { value: 'instructor', label: 'I want to Teach', sublabel: 'Create courses', icon: GraduationCap },
                ...
                <button
                  ...
                  className={cn(
                    'relative flex flex-col items-center gap-1.5 rounded-lg border-2 p-4 text-center transition-all',
                    selectedRole === value
                ...
                >
                  ...
                  <Icon className={cn('w-7 h-7', selectedRole === value ? 'text-primary' : 'text-muted-foreground')} />
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="flex items-start gap-2">
                ...
                <label htmlFor="terms" className="text-sm text-muted-foreground cursor-pointer">
                  I agree to the{' '}
                  <Link to="/terms" className="text-foreground hover:underline font-medium">Terms</Link>
                  {' '}and{' '}
